...
public class AppTest extends TestCase {
    //TODO: wire this up correctly and separate out tests
...
//        assertTrue("ENSG00000178104".equals(commonGenes.get(0)));
//    }
//
//
//    /**
...
//    }
    ...
    private Patient getTestPatient() {
        ...
        //disorders
        List<Map<String, String>> disorders = new ArrayList<>();
        Map<String, String> disorder1 = new HashMap<>();
        disorder1.put("id", "MIM:614261");
        disorders.add(disorder1);
        Map<String, String> disorder2 = new HashMap<>();
        disorder2.put("label", "#614261 MICROCEPHALY-CAPILLARY MALFORMATION SYNDROME; MICCAP");
        disorders.add(disorder2);

        //features
        List<PhenotypeFeature> features = new ArrayList<>();
